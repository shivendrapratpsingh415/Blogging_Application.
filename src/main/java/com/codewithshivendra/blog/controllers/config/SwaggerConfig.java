...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend Course",
				"This project is developed by Learn Code With shivendra", "1.0", "Terms of Service",
				new Contact("shivendra", "https://github.com/pratapshivendra817", "shivendrapratap415@gmail.com"),
